...
public class StringDifferences {
	public static void main(String[] args) {
		...
		if (inputStr1.length() > inputStr2.length()) {// tests to see which string is shorter to use for iteration
		...
		System.out.println("Number of Differences: " + diffCounter); // prints the number of differences
